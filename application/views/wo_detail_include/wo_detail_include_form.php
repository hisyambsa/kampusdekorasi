...
<h2 style="margin-top:0px"><?php echo $button ?> Wo_detail_include </h2>
	    ...
	    <div class="form-group">
            <label for="int">Id Detail Include Include <?php echo form_error('id_detail_include_include') ?></label>
            <input type="text" class="form-control" name="id_detail_include_include" id="Masukan id_detail_include_include" placeholder="Id Detail Include Include" value="<?php echo $id_detail_include_include; ?>" />
        </div>
	    <div class="form-group">
