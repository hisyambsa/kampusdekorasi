<a href="<?php echo base_url('laporan/cetakLaporan/') ?><?php echo $namaLaporan.'/'.$dataTanggalAwal.'/'.$dataTanggalAkhir ?>">
	<button class="btn btn-primary btn-rounded">Cetak</button><a href="#" class="btn btn-elegant btn-sm disabled ">Jumlah Data : <?php echo $total_rows ?></a>
