	...
	<div class="card card-cascade wider reverse">
		...
		<div class="card-body card-body-cascade">
			...
			<p class="card-text">
				...
				<li>
					Pemasangan dekorasi H-1 dan bongkar dekorasi H+1 
					(kecuali gedung dibongkar pada hari H)
				</li>
				<li>
					Perlu survey lokasi atau tidak, kami yang menentukan, menyesuaikan situasi.
				</li>
				<li>
