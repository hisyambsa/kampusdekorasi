      ...
      <div class="row">
        <div class="col-md">
         <div class="form-group">
          ...
          <input type="text" class="form-control" name="email" id="id_email" placeholder="Email" value="<?php echo $email; ?>" />
        </div>
        <div class="form-group">
          <label for="varchar">Nama Lengkap <?php echo form_error('nama_user') ?></label>
          <input type="text" class="form-control" name="nama_user" id="id_nama_user" placeholder="Nama Lengkap" value="<?php echo $nama_user; ?>" />
        </div>
        <div class="form-group">
          <label for="varchar">Tempat Lahir <?php echo form_error('tempat_lahir') ?></label>
          <input type="text" class="form-control" name="tempat_lahir" id="id_tempat_lahir" placeholder="Tempat Lahir" value="<?php echo $tempat_lahir; ?>" />
        </div>
        <div class="form-group pt-1">
          <!-- <input type="text" readonly class="form-control ambilTanggal" name="tanggal_lahir" id="id_tanggal_lahir" placeholder="Tanggal Lahir" value="<?php echo $tanggal_lahir; ?>" /> -->
          <div class="md-form">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="alamat" id="id_alamat" placeholder="Alamat" value="<?php echo $alamat; ?>" />
        </div>
        <div class="form-group">
          <label for="varchar">Hp <?php echo form_error('hp') ?></label>
          <input type="number" class="form-control" name="hp" id="id_hp" placeholder="Hp" value="<?php echo $hp; ?>" />
        </div>
      </div>
      <div class="col-md">
        <div class="form-group">
