			...
			<div class="col-md-4">
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<a href="" data-idPackage="<?php echo $wo_package->id_package ?>" class="btn btn-primary btn-sm btn-rounded float-right" data-toggle="modal" data-target="#modalBooking">Booking</a> 
