...
class Email extends CI_Controller {
	...
	public function sendEmail($email,$subject,$message,$attach=NULL)
	{
		$config = Array(
			...
			'smtp_port' => 465,
			'smtp_user' => 'server.telko@gmail.com', 
			'smtp_pass' => 'Lti123!@#', 
			'mailtype' => 'html',
			'charset' => 'iso-8859-1',
			'wordwrap' => TRUE
		...
		$this->email->from('server.telko@gmail.com');
		$this->email->to($email);
...
// show_error($this->email->print_debugger());
	public function send_email() 
	{
		...
		<p>Kantor:</p>
		<p>Bojong Gede</p>
		<p>Jl. Letjen MT Haryono, Kav. 23 &nbsp;&ndash; &nbsp;Jakarta 12820</p>
		<p>Telp. : +62 21 8378 2445 &nbsp; &ndash; &nbsp; Fax. : +62 21 8378 2447</p>
		";
