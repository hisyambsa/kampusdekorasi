...
class Wo_package extends CI_Controller
{
    ...
    public function create_action() 
    {
		...
		'foto_package' => $this->input->post('foto_package',TRUE),
	    );
    ...
    public function update_action() 
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            $this->update($this->input->post('id_package', TRUE));
        } else {
            $data = array(
		'nama_package' => $this->input->post('nama_package',TRUE),
		'detail_package' => $this->input->post('detail_package',TRUE),
    ...
    {
	$this->form_validation->set_rules('nama_package', 'nama package', 'trim|required');
	...
	$this->form_validation->set_rules('foto_package', 'foto package', 'trim|required');
