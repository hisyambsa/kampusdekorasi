...
class Wo_user extends CI_Controller
{
    ...
    public function create_action() 
    {
		...
		'foto_kk' => $this->input->post('foto_kk',TRUE),
	    );
    ...
    public function update($id) 
    {
		...
		'foto_kk' => set_value('foto_kk', $row->foto_kk),
	    );
            $this->load->view('wo_user/wo_user_form', $data);
            $this->load->view('inc/footer-js-admin');
        } else {
	...
	$this->form_validation->set_rules('foto_kk', 'foto kk', 'trim|required');
